# testcase_3
### Circuit
<center> <img src = ../../pic/circuit3.png width = 50%> </center>

> `Netlist3.txt`为本电路的PSPICE格式网表表示
### Circuit Parameters
...
$ Ie_4=fe_4-a_r*fc_4 $
$ Ic_4=fc_4-a_f*fe_4 $
$ fe_1=\frac{Is}{a_f}*(e^{(n*(x_8-x_1))}-1) $
$ fc_1=\frac{Is}{a_r}*(e^{(n*(x_4-x_1))}-1) $
$ fe_2=\frac{Is}{a_f}*(e^{(n*(x_8-x_6))}-1) $
$ fc_2=\frac{Is}{a_r}*(e^{(n*(x_{10}-x_6))}-1) $
$ fe_3=\frac{Is}{a_f}*(e^{(n*(x_9-x_1))}-1) $
$ fc_3=\frac{Is}{a_r}*(e^{(n*(x_5-x_1))}-1) $
$ fe_4=\frac{Is}{a_f}*(e^{(n*(x_9-x_7))}-1) $
$ fc_4=\frac{Is}{a_r}*(e^{(n*(x_{12}-x_7))}-1) $
...
> 详见文件`jacobian3.m`
### Standard Solution
<center> <img src = ../../pic/std_sol3_fig.png width = 50%> </center>
<center> 同伦法求解图像 </center>
<table>
    <tr>
        <td> <center> <img src = ../../pic/std_sol3_mat.png> 同伦法解 </center> </td>
        <td> <center> <img src = ../../pic/std_sol3_ps.png>PSPICE</center> </td>
    </tr>
</table>
### Test Method
